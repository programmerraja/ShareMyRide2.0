...
async function post(req,res){
      if(!validator.isEmail(req.body.email)){ 
          res.render("signupRider",{error_msg:"Invalid Email"}); 
          return
      }
      ...
      if(!user){
            ...
            if(new_rider){
                ...
                if(msg){
                  ...
                  await Rider.deleteOne({_id:new_rider._id}).catch((err)=>
                              {
                                let error_msg=dbErrorHandler(err)
                                res.render("signupRider",
                                {
                  ...
                  res.render("signupRider",{error_msg:"Sorry Something went wrong. Please try again"});
                }
              }
      }
      //if he is user
      else{
              res.render("signupRider",{error_msg:"Sorry Your Email Exit in user account try different email"});
