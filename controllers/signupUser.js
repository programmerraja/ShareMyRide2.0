...
async function postHandler(req,res){
      ...
      if(!validator.isEmail(req.body.email)){ 
          res.render("signupUser",{error_msg:"Invalid Email"}); 
          return
      }
      ...
      if(!rider){
        ...
        if(new_user){
            ...
            if(msg){
              ...
              res.render("signupUser",{error_msg:"Sorry Something went wrong. Please try again"});
            }
        }
      }
      //if he is user
      else{
          res.render("signupUser",{error_msg:"Sorry Your Email Exit in Rider account try different email"});
        }
}
